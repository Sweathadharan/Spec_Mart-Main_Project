...
-- eyepower
CREATE TABLE `eye_power` (
  `Power_ID` int(11) PRIMARY KEY,
  `Customer_ID` int(11) FOREIGN NULL,
  `Product_ID` int(11)  FOREIGN KEY,
  `Lefteye` float(10,2) DEFAULT 0.00,
  `Righteye` float(10,2) DEFAULT 0.00,
 
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `users` (`Power_ID`, `Customer_ID`, `Product_ID`, `Lefteye`, `Righteye`) VALUES
(1, 20,4 ,2.22 ,4.02 )
